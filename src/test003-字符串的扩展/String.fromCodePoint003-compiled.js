...
console.log("**************001");
{
   ...
   */
  var r = String.fromCharCode(0x20BB7);
  console.info(r); // "ஷ"
}
/**
...
console.log("**************002");
{
  var r1 = String.fromCodePoint(0x20BB7);
  console.info(r1); // "𠮷"

  //如果String.fromCodePoint方法有多个参数，则它们会被合并成一个字符串返回。
  var r2 = String.fromCodePoint(0x78, 0x1f680, 0x79) === "x\uD83D\uDE80y";
...
//# sourceMappingURL=String.fromCodePoint003-compiled.js.map