 ...
 */
{
  var _r = Symbol.for("bar") === Symbol.for("bar");
  console.info(_r); // true

  _r = Symbol("bar") === Symbol("bar");
...
{
  var s1 = Symbol.for("foo");
  var _r2 = Symbol.keyFor(s1);
  console.info(_r2); // "foo"

  var s2 = Symbol("foo");
  _r2 = Symbol.keyFor(s2);
  console.info(_r2); // undefined
}
/**
...
//# sourceMappingURL=Symbol.for().Symbol.keyFor().005-compiled.js.map