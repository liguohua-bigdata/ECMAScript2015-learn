 ...
 */
{
    ...
    // ES5的写法
    var arr1 = [].slice.call(_arrayLike); // ['a', 'b', 'c']
    // ES6的写法
    var arr2 = Array.from(_arrayLike); // ['a', 'b', 'c']
}
/**
 ...
 */
{
    ...
    // map()
    var names1 = Array.prototype.map.call(spans, function (s) {
        return s.textContent;
    });

    // Array.from()
    var names2 = Array.from(spans, function (s) {
        return s.textContent;
    });
}
/**
 ...
 */
{
    var countSymbols = function countSymbols(string) {
        return Array.from(string).length;
    };
}

//# sourceMappingURL=Array.from().001-compiled.js.map